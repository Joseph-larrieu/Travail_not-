...
public class TodoControllerTest {
    ...
    void setUp() {
        todos = new ArrayList<>() {{
            ...
            add(new Todo(14L, "task4", false, "27-06-06"));
            add(new Todo(7L, "task5", true, "27-06-06"));
            add(new Todo(28L, "task6", true, "27-06-06"));
        }};
    ...
    @Test
    void whenGettingAll_shouldGet6() throws Exception {
    ...
    void whenGettingId7L_shouldReturnSame() throws Exception{
        ...
        ).andExpect(jsonPath("$.content", is("lower"))
    ...
    void whenCreatingNew_shouldReturnLink_andShouldBeStatusCreated() throws Exception {
        Todo new_todo = new Todo(89L, "newTask", false, "27-06-06");
    ...
    void whenUpdating_shouldReceiveTodoToUpdate_andReturnNoContent() throws Exception {
        ...
        Todo updated_todo = new Todo(initial_todo.getId(), "updated task", initial_todo.getEtat(), intial_todo.getCreation();
        ArgumentCaptor<Todo> todo_received = ArgumentCaptor.forClass(Todo.class);
